...
import 'package:bkinternacionalizacao/components/error.dart';
...
import 'package:bkinternacionalizacao/components/transaction_auth_dialog.dart';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<TransactionFormCubit, TransactionFormState>(
      ...
      if (state is ShowFormState) {
        return _BasicForm(this._contact);
      }
